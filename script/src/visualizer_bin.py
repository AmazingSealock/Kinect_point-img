...
class Visualizer:
    def __init__(self, cfg_path):
        ...
        self.vis.create_window(window_name='semantic-kitti', visible=True)
        ...
        self.render_option.point_size = 4
    ...
    def __load_pcd_bin(self, pcd_path):
        ...
        # coordinate = filter_points_Z(coordinate, thre=1.662)
        # coordinate = filter_points_X(coordinate, thre=10)
        # coordinate = filter_points_Y(coordinate, thre=10)
...
if __name__ == '__main__':
    visualizer = Visualizer("C:/Users/maser/Documents/GitHub/SemanticKITTI-visualizer/src/config/visualizer_bin.yaml")
    visualizer.run()   
